...
public class MainActivity extends AppCompatActivity {
    ...
    String[] judulMovie, tglRilis, durasiMovie, genres, sinopsis, rate, ratingVote;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ratingVote  = getResources().getStringArray(R.array.list_voting_rate);
        ...
        for (int x = 0; x < judulMovie.length; x++) {
            ...
            movies.setVoting(Float.valueOf(ratingVote[x]));
